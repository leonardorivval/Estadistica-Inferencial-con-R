...
<li> A poll conducted by WIN-Gallup International surveyed 51,927 people from 57 countries.
</li>

The correct answer is: A poll conducted by WIN-Gallup International surveyed 51,927 people from 57 countries
</ol>
...
The correct answer is: Individual Persons
</ol>
...
First, we need our data to be independent and because we have random sampling we can be sure that it is in fact independent. Second, the data must fulfill the success and failure condition, and since the sample is so big we can be sure that 1002(.05)>10 and 1002(1-.05)>10. In fact, the former is 50.1 and the latter is 951
</div>
...
Is basically the range of values of our confidence interval given a point estimate. Which would delimit the range were we are 95% confident that the true population proportion resides.
</div>
...
The answer is: The margin of error for the estimate of the proportion of atheists in the US in 2012 is 0.0135
</ol>
?inference()
...
mean(can12$response== "atheist")
mean(russ12$response=="atheist")

inference(y=response, data = can12, type = "ci", statistic = "proportion", method = "theoretical", success = "atheist")

inference(y=response, data = russ12, type="ci", statistic = "proportion", method = "theoretical", success = "atheist")
```
...
This one is the false: The most conservative estimate when calculating a confidence interval occurs when $p$ is set to 1.

The most conservative is always the middle point, in this case would be .50
</ol>
...
p= .39 therefore the H0 is not rejected
</ol>
```{r spain-05-12}
...
inference(y=response, x=year, data=spain_athe, type = "ht", method = "theoretical", statistic = "proportion", alternative = "twosided", success = "atheist")
```
...
p=.0001 therefore H0 is rejected. This means that there is a significant increase in the number of atheists in US from 2005 to 2012.
...
inference(y=response, x=year, data=us_athe, type = "ht", method = "theoretical", statistic = "proportion", alternative = "twosided", success = "atheist")
```
...
Which is just our critical value
</ol>
...
The answer is: At least 9604 people
</ol>
```{r sample-size}
